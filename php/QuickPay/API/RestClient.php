 ...
 *
 * Modified for QuickPay use by Tim Warberg <tlw@interface.dk>
 *  - PHP 5.3 namespacing
 *  - Added additional headers option
 */
...
class RestClient {
      ...
      * @return RestClient
      */
     public static function post($url,$params=null,$user=null,$pwd=null,$contentType="multipart/form-data",$headers=null) {
         return self::call("POST",$url,$params,$user,$pwd,$contentType,$headers);
     }
      ...
      * @return RestClient
      */
     public static function put($url,$body,$user=null,$pwd=null,$contentType=null,$headers=null) {
         return self::call("PUT",$url,$body,$user,$pwd,$contentType,$headers);
     }
      ...
      * @return RestClient
      */
     public static function get($url,array $params=null,$user=null,$pwd=null,$headers=null) {
         return self::call("GET",$url,$params,$user,$pwd,null,$headers);
     }
      ...
      * @return RestClient
      */
     public static function delete($url,array $params=null,$user=null,$pwd=null,$headers=null) {
         return self::call("DELETE",$url,$params,$user,$pwd,null,$headers);
     }
      ...
      * @return RestClient
      */
     public static function call($method,$url,$body,$user=null,$pwd=null,$contentType=null,$headers=null) {
